...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $news = $em->getRepository('TestNewsBundle:News')->findAll();
    ...
    {
        $news = new News();
        $form = $this->createForm('Test\NewsBundle\Form\NewsType', $news);
    ...
    {
        $deleteForm = $this->createDeleteForm($news);
        $editForm = $this->createForm('Test\NewsBundle\Form\NewsType', $news);
